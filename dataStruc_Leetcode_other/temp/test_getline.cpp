...
# 578 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.tcc" 3
    ...
    template<typename _CharT, typename _Traits, typename _Alloc>
                ...
                basic_string<_CharT, _Traits, _Alloc>& __str, _CharT __delim)
        {
            ...
            __size_type __extracted = 0;  // 提取
            const __size_type __n = __str.max_size();  // string能容纳最大字符数:3FFFFFFFFFFFFFF9
            typename __ios_base::iostate __err = __ios_base::goodbit;  // 枚举值 0
